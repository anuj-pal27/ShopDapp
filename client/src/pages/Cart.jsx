        ...
        <div className="md:flex gap-20">
          ...
          <div className="md:flex flex-col h-[80vh] justify-around">
            <div className="flex flex-col mt-16 gap-2">
              <h2 className="text-3xl text-green-600 font-bold text-center">Your Cart</h2>
              <h2 className="text-5xl text-green-800 font-semibold text-center">Summary</h2>
            </div>
            <div>
              ...
              <Link to={"/checkout"} className="md:ml-0 ml-[50%]">
                <button className="border border-green-600 px-16 rounded-md md:ml-0 -translate-x-[50%] md:translate-x-0 p-2 text-white bg-green-600 font-bold text-xl mt-6">
                  Checkout Now
                </button>
              </Link>
            </div>
